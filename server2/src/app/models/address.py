...
class Address(Base):
    ...
    label: Mapped[Optional[str]] = mapped_column("label", String(50), nullable=True)

    recipient_first_name: Mapped[str] = mapped_column("recipientFirstName", String(100), nullable=False)
    recipient_last_name: Mapped[Optional[str]] = mapped_column("recipientLastName", String(100), nullable=True)
